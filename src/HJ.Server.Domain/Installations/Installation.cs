...
public class Installation
{
    ...
    private Installation(Guid installationId, Guid productId, Guid productVersionId, Guid? tenantId)
    {
        Id = Guid.NewGuid();
    ...
    public static Installation Create(Guid installationId, Guid productId, Guid productVersionId, Guid? tenantId)
    {
        ...
        return new Installation(installationId, productId, productVersionId, tenantId);
    }
